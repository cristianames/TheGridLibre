...
Publicacion_Fecha_Venc,Publicacion_Precio,
...
where 
Publ_Cli_Dni is not null and R.Nombre = Publicacion_Rubro_Descripcion and 
C.Documento = Publ_Cli_Dni
...
R.Nombre = Publicacion_Rubro_Descripcion and 
E.Razon_Social = Publ_Empresa_Razon_Social
