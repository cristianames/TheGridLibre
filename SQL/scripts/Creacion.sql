create table pruebasDeScript.dbo.TG_Usuario(
...
create table pruebasDeScript.dbo.TG_Rol(
	ID_Rol numeric(18,0) identity(1,1) primary key,
	Nombre varchar(20) unique,
	Inhabilitado bit
)

create table pruebasDeScript.dbo.TG_Rubro(
	ID_Rubro numeric(18,0) identity(1,1) primary key,
	Nombre varchar(20) unique,
	Descripcion varchar(50)
)

create table pruebasDeScript.dbo.TG_Visibilidad(
...
create table pruebasDeScript.dbo.TG_Factura(
	ID_Factura numeric(18,0) identity(100000,1) primary key,
	Fecha date,
	Forma_Pago varchar(30),
	Nro_Tarjeta numeric(20,0)
)
create table pruebasDeScript.dbo.TG_Roles_x_Usuario(
...
create table pruebasDeScript.dbo.TG_Funcionalidades_x_Rol(
	ID_Rol numeric(18,0) references TG_Rol(ID_Rol) Primary Key,
	Nombre varchar(20),
	Descripcion varchar(50)
)

create table pruebasDeScript.dbo.TG_Caracteristicas_x_Rol(
	ID_Rol numeric(18,0) references TG_Rol(ID_Rol) Primary Key,
	Caracteristicas varchar(50)
)

create table pruebasDeScript.dbo.TG_Informacion(
...
create table pruebasDeScript.dbo.TG_Direccion(
	ID_User numeric(18,0),
	ID_Rol numeric(18,0),
...
create table pruebasDeScript.dbo.TG_Publicacion(
...
create table pruebasDeScript.dbo.TG_Oferta(
...
create table pruebasDeScript.dbo.TG_Compra(
...
create table pruebasDeScript.dbo.TG_Publicaciones_x_Rubro(
	ID_Rubro numeric(18,0) references TG_Rubro(ID_Rubro),
	ID_Publicacion numeric(18,0) references TG_Publicacion(ID_Publicacion),
	Primary Key(ID_Rubro,ID_Publicacion)
)

create table pruebasDeScript.dbo.TG_Preguntas(
